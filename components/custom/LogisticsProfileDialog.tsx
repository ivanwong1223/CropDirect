...
interface LogisticsProfileDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export default function LogisticsProfileDialog({
  open,
  onOpenChange,
}: LogisticsProfileDialogProps) {
      ...
      <AlertDialogContent className="max-w-md">
        <AlertDialogHeader className="text-center">
          <AlertDialogTitle className="text-2xl font-semibold text-center">
            Complete Your Logistics Profile
          </AlertDialogTitle>
          <AlertDialogDescription className="text-lg text-center leading-8 text-gray-600 font-medium mt-4 mb-2 tracking-wide">
            Your logistics profile is incomplete. Please finish setting up your profile detail to proceed
          </AlertDialogDescription>
        </AlertDialogHeader>
...
export function KYBVerificationDialog({
  open,
  onOpenChange,
  kybStatus,
