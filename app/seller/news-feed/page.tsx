...
export default function NewsFeedPage() {
  ...
  const fetchNewsData = async () => {
    try {
      ...
      console.log("The returned news data is: ", data.data);
    } catch (err) {
  ...
  // Sort news data based on published_at date
  const sortedNewsData = React.useMemo(() => {
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Agricultural News Feed</h1>
          <p className="text-gray-600">Stay updated with the latest agriculture news and trends</p>
        </div>
...
//           <h1 className="text-3xl font-bold text-gray-900 mb-4">Agriculture News Feed</h1>
...
//   }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Header Section */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2 mt-6">Agricultural News Feed</h1>
        <p className="text-gray-600 mb-4">Stay updated with the latest agriculture news and trends</p>
